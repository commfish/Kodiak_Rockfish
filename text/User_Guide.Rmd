...
to load the *rockfish.RData* workspace located in the *code* subdirectory of the current working directory and see a list of its contents, which currently consist of the three R functions `display_station_data()`, `get_haver_distance()` and `get_station_estimates()`.
