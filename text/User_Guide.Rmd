...
The results are also written to the station directory as file *estimates.csv*. Corresponding commands for displaying data and obtaining estimates of abundance and density at a station named "AS01" using star-transect sampling are
```{r, eval = FALSE}
display_station_data("AS01", grid = FALSE)

get_station_estimates("AS01", N = 11, grid = FALSE)
